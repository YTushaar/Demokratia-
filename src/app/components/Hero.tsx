export default function Hero() {
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-600/30 rounded-full blur-[120px]" />
      
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto space-y-8">
        <img 
          src="/team/logo.jpeg" 
          alt="Demokratia Logo" 
          className="w-32 h-32 md:w-40 md:h-40 object-cover rounded-full mx-auto shadow-[0_0_50px_rgba(79,70,229,0.4)] border-2 border-blue-500/30 animate-fade-in-up" 
        />
        <div className="inline-block px-4 py-1.5 rounded-full border border-blue-500/30 bg-blue-500/10 backdrop-blur-md text-blue-300 text-sm font-medium tracking-wide uppercase mb-4 animate-fade-in-up">
